...
const flowPassSao = addKeyword(["3", "Tres"])
  .addAnswer([
    ...
    "🧔🏻‍♂️ Cesar Eduardo Zepeda Melendez -- *Becario de TI* -- 📞993 189 4332",
  ])
  .addAnswer("Para regresar al menu, escribe Menu");
...
const flowSao = addKeyword(["6", "Seis"]).addAnswer(
  [
    "¿Que problema tienes?",
    "1️⃣.-No tengo cuenta del portal de Requisiciones",
    "2️⃣.-¿Cual es el Link de la plataforma de Requisiciones?",
    "3️⃣.-Usuario o Contraseña Incorrecta",
    "4️⃣.-Ceco o insumo faltante",
...
const flowPassNext = addKeyword(["3", "Tres"])
  .addAnswer([
    ...
    "👨🏽 Rafael de la Cruz Ramos -- *Auxiliar de TI* -- 📞993 104 4174",
...
const flowNext = addKeyword(["5", "Cinco"]).addAnswer(
  [
    "¿Que problema tienes?",
    "1️⃣.-No tengo cuenta de Nextcloud",
    "2️⃣.-¿Cual es el Link de la plataforma de Nextcloud?",
    "3️⃣.-Usuario o Contraseña Incorrecta",
    "Para regresar al menu principal, escribe *Menu*",
  ],
  null,
...
const flowTickets = addKeyword(["4", "Cuatro"]).addAnswer(
  [
    "¿Que problema tienes?",
    "1️⃣.-No tengo cuenta de Tickets",
    "2️⃣.-¿Cual es el Link de la plataforma de Tickets?",
    "3️⃣.-Usuario o Contraseña Incorrecta",
    "Para regresar al menu principal, escribe *Menu*",
  ],
  null,
...
const flowReceiptError = addKeyword(["6", "Seis"])
  ...
  .addAnswer([
    "*Soluciones:*",
    "1️⃣.-Comunicarse con TI para notificar que correo ya no tiene espacio",
    "2️⃣.-Al redactar el correo eliminar al destinatario que tiene el error para poder enviar el correo",
  ])
  .addAnswer([
...
const flowErrorBig = addKeyword(["5", "cinco"])
  ...
  .addAnswer([
    "*Soluciones:*",
    "1️⃣.-Comprimir los archivos en .zip o .rar",
    "2️⃣.-Subir los archivos al Nextcloud y compartir un enlace con los archivos",
    "3️⃣.-Mandar los archivos por partes",
  ])
  .addAnswer("Para regresar al menu, escribe Menu");
...
const flowOutlook = addKeyword("1", "outlook", "uno", "atras")
  .addAnswer(
    "1️⃣ *Primer Paso* Abrir el administrador de tareas con un clic derecho en la barra de tareas"
  )
  .addAnswer(
    "2️⃣ *Segundo paso* En la pestaña de procesos buscar la tarea con nombre Microsoft Outlook"
  )
  .addAnswer(
    "3️⃣ *Tercer paso* Da clic derecho en ese proceso y damos clic en *Finalizar la tarea* "
  )
  .addAnswer("4️⃣ *Cuarto paso* Vuelva a abrir la aplicacion Outlook")
  .addAnswer(
...
const flowCorreo = addKeyword(["3", "tres", "regresar"]).addAnswer(
  [
    "¿Que problema tienes?",
    "1️⃣.-No me deja abrir el Outlook",
    "2️⃣.-¿Cual es el Link de la plataforma de correo?",
    "3️⃣.-Usuario o Contraseña Incorrecta",
    "4️⃣.-Firma del correo",
    "5️⃣.-Error 550 Message Too Big",
    "6️⃣.-Error 550 Recipient correo has exceeded mailbox limit ",
    "7️⃣.-Error Your Box is Full",
    "Para regresar al menu principal, escribe *Menu*",
  ],
  null,
  null,
...
const flowcontactos = addKeyword(["1", "uno", "contactos"])
  .addAnswer(
    "👨🏻Juan Miguel Aguirre Paredes -- *Coordinador de TI* -- 📞 9931908780"
  )
  .addAnswer("👨🏽 Rafael de la Cruz Ramos -- *Auxiliar de TI* -- 📞 9931044174")
  .addAnswer("👨🏽 Izamer Sanchez Perez -- *Auxiliar de TI* -- 📞 9932437599")
  .addAnswer("👨🏽 Edgar Eduardo Jimenez -- *Becario de TI* -- 📞 9932778223")
  .addAnswer(
    "🧔🏻‍♂️ Cesar Eduardo Zepeda Melendez -- *Becario de TI* -- 📞 9931894332"
  )
  .addAnswer("Para regresar al menu, escribe *Menu*");
...
const flowPrincipal = addKeyword(["hola", "buenos", "dias", "tardes", "menu"])
  ...
  .addAnswer(
    [
      ...
      "1️⃣.-Contactos de TI",
      "2️⃣.-Enlaces de TI",
      "3️⃣.-Correo corporativo",
      "4️⃣.-Tickets",
      "5️⃣.-Nextcloud",
      "6️⃣.-Portal de requisiciones",
    ],
    null,
    null,
